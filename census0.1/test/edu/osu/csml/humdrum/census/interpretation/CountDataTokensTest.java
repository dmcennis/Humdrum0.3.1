 ...
 *
 */
public class CountDataTokensTest {
	...
	/**
	 * Test method for {@link edu.osu.csml.humdrum.census.interpretation.CountDataTokens#output()}.
	 */
	@Test
	public void testEmpty() throws FileNotFoundException{
		...
		for(int i=0;i<checks.length;++i){
			if(checks[i] instanceof CountDataTokens){
				String outs = ((CountDataTokens)checks[i]).output();
