...
public class CountInterpretationsTest {
	...
	public void testEmpty() throws FileNotFoundException{
		...
		for(int i=0;i<checks.length;++i){
			if(checks[i] instanceof CountInterpretations){
				String outs = ((CountInterpretations)checks[i]).output();
