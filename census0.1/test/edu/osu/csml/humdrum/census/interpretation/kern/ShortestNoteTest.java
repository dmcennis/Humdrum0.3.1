...
public class ShortestNoteTest {
	...
	/**
	 * Test method for {@link edu.osu.csml.humdrum.census.interpretation.kern.ShortestNote#output()}.
	 */
	@Test
	public void testEmpty() throws FileNotFoundException{
		...
		for(int i=0;i<checks.length;++i){
			if(checks[i] instanceof ShortestNote){
				String outs = ((ShortestNote)checks[i]).output();
